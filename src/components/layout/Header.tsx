        ...
        <div className="flex items-center justify-between h-[76px]">
          ...
          <div className="flex items-center gap-2">
            ...
            <Link href="/cart" className="relative text-steel-400 hover:text-amber-400 transition-all duration-300 p-2.5 group" aria-label="Shopping cart">
              ...
              <span className="absolute -top-0.5 -right-0.5 bg-amber-500 text-navy-900 text-[10px] w-4.5 h-4.5 rounded-full flex items-center justify-center font-bold shadow-sm">0</span>
            </Link>
