...
export const metadata: Metadata = {
  ...
  description: 'Shaft and housing fit recommendations, tolerance tables, and installation guidance.',
};
  ...
  return (
    <div className="max-w-4xl mx-auto px-4 py-8">
      <Breadcrumb items={[
        ...
        { label: 'Fit & Tolerance Guide' },
      ]} />

      <h1 className="text-3xl font-extrabold mb-4" style={{ fontFamily: 'var(--font-heading)' }}>Fit & Tolerance Guide</h1>
      <p className="text-muted mb-10">Shaft and housing fit recommendations, tolerance tables, and installation guidance.</p>
