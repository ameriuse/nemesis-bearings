...
export const metadata: Metadata = {
  ...
  description: 'Grease and oil selection, relubrication intervals, and best practices for bearing lubrication.',
};
...
export default function Page() {
  return (
    <div className="max-w-4xl mx-auto px-4 py-8">
      ...
      <h1 className="text-3xl font-extrabold mb-4" style={{ fontFamily: 'var(--font-heading)' }}>Lubrication Guide</h1>
      <p className="text-muted mb-10">Grease and oil selection, relubrication intervals, and best practices for bearing lubrication.</p>
