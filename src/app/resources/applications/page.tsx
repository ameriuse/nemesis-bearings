...
export const metadata: Metadata = {
  ...
  description: 'Bearing solutions organized by industry and application type.',
};
...
export default function Page() {
  return (
    <div className="max-w-4xl mx-auto px-4 py-8">
      ...
      <h1 className="text-3xl font-extrabold mb-4" style={{ fontFamily: 'var(--font-heading)' }}>Industry Applications</h1>
      <p className="text-muted mb-10">Bearing solutions organized by industry and application type.</p>
